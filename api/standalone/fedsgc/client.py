...
class Client:
    ...
    def train(self, w_global, mode, round_idx, global_direction_map=None):
        ...
        gradients = self.model_trainer.train(self.local_training_data, self.device, self.args, mode, round_idx, global_direction_map=None)
        weights = self.model_trainer.get_model_params()
