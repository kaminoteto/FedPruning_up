...
class FedTinyTrainer(object):
    ...
    def test(self):
        # train data
        test_metrics = self.trainer.test(self.train_local, self.device, self.args)
        test_total, test_loss, test_acc = test_metrics['test_total'], \
        ...
        return test_total, test_loss, test_acc
