...
class FedSGCTrainer(object):
    ...
    def train(self, mode, round_idx = None, global_direction_map=None):
        masks = self.trainer.train(self.train_local, self.device, self.args, mode, round_idx, global_direction_map=None)
    ...
    def get_lambda_k(self):
        return self.args.lambda_param

    def get_beta_k(self):
        return self.args.beta_param

    def get_gradient(self, key):
        return self.trainer.get_gradient(key)
