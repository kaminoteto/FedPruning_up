...
class FedHMLAggregator(object):
    ...
    def __init__(self, train_global, test_global, all_train_data_num,
        ...
        self.mask_dict = dict() # Initialized
    ...
    def add_local_trained_result(self, index, model_params, local_sample_number, gradient=None):
        logging.info("add_model. index = %d" % index)
        self.model_dict[index] = model_params
        self.sample_num_dict[index] = local_sample_number
    ...
    def aggregate(self):
        ...
        # Return only the dictionary, not a tuple
    ...
    def _generate_validation_set(self, num_samples=10000):
        if self.args.dataset in ["fed_shakespeare", "stackoverflow_nwp", "stackoverflow_lr"]:
            return self.test_global
        elif self.test_global is None:
            return None
        else:
