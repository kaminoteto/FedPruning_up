...
from .FedMefAggregator import FedMefAggregator
from .FedMefTrainer import FedMefTrainer
...
def init_server(
    ...
    if preprocessed_sampling_lists is None:
        server_manager = FedMefServerManager(args, aggregator, comm, rank, size, backend)
    else:
        server_manager = FedMefServerManager(
            args,
            aggregator,
            comm,
            rank,
...
def init_client(
    ...
    client_manager = FedMefClientManager(args, trainer, comm, process_id, size, backend)
    client_manager.run()
