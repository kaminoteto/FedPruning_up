...
``` 
# CIFAR10
sh run_fedavg_standalone_pytorch.sh 0 10 10 10 cifar10 ./../../../data/cifar10 resnet56 hetero 200 1 0.1 0.01 0.001 sgd 0 0.5
```
...
For large DNNs (ResNet, Transformer, etc), please use the distributed computing (api/distributed). 
