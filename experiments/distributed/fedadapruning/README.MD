...
```
# general test 
sh run_fedadapruning_distributed_pytorch.sh resnet18 cifar10 100 10 500 5 0.05 1. --delta_T 2 --T_end 300 --num_eval 128 --frequency_of_the_test 10 --client_optimizer sgd --batch_size 64 --enable_adaptive_aggregation 0 --enable_ts 1 --aggregated_gamma 0.5
