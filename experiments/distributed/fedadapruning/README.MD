...
```
# general test 
CUDA_VISIBLE_DEVICES=0,1,2,3 sh run_fedadapruning_distributed_pytorch.sh resnet18 cifar10 100 10 500 5 0.05 1. --delta_T 5 --T_end 300 --num_eval 128 --frequency_of_the_test 10 --client_optimizer sgd --batch_size 64 --enable_adaptive_aggregation 0 --enable_ts 1 --aggregated_gamma 0.5 --initial_distribution_ratio 0.5 
# --adjustment_epochs None --growth_data_mode batch --client_optimizer adam

# quick test 
CUDA_VISIBLE_DEVICES=4,5,6,7 sh run_fedadapruning_distributed_pytorch.sh resnet18 cifar10 100 10 500 5 0.1 0.001 --delta_T 10 --T_end 300 --num_eval 128 --frequency_of_the_test 10 --enable_adaptive_aggregation 0 --adaptive_beta 0.1 --enable_ts 1 --aggregated_gamma 0.5 --initial_distribution_ratio 0.5 --client_optimizer adam 
