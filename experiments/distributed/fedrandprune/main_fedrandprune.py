...
from api.distributed.fedrandprune.FedRandPruneAPI import FedML_init, FedML_FedRandPrune_distributed
...
if __name__ == "__main__":
    ...
    str_process_name = "FedRandPrune (distributed):" + str(process_id)
    ...
    FedML_FedRandPrune_distributed(
        process_id,
        worker_number,
        device,
        comm,
