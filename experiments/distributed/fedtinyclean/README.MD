...
```
CUDA_VISIBLE_DEVICES=[gpus] sh run_fedtinyclean_distributed_pytorch.sh [model] [dataset] [client_num_in_total] [client_num_per_round]  [comm_round] [epochs] [batch_size] [initial_lr] [target_density]  {--delta_T , --T_end, --partition_alpha, --num_eval, --frequency_of_the_test}
```
