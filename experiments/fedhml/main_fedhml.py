...
from api.distributed.fedhml.FedHMLAPI import FedML_init, FedML_FedHML_distributed
def add_args(parser):
    """
    ...
    parser.add_argument("--lambda_etr", type=float, default=0, help='the ratio of topological pruning (0) to magnitude pruning (1)')
...
if __name__ == "__main__":
    ...
    str_process_name = "FedHML (distributed):" + str(process_id)
